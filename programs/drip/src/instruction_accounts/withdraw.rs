...
pub struct ClosePositionAccounts<'info> {
    ...
    #[account(
        ...
        constraint = vault_period_user_expiry.vault == vault.key() @DripError::InvalidVaultReference,
    ...
    #[account(
        ...
        constraint = user_token_a_account.mint == vault.token_a_mint @DripError::InvalidMint
    )]
    ...
    #[account(
        ...
        mut,
        constraint = user_position_nft_mint.key() == user_position.position_authority @DripError::InvalidMint,
